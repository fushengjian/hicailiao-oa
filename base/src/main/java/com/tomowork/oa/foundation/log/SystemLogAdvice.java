package com.tomowork.oa.foundation.log;
...
public class SystemLogAdvice {
	...
	@AfterReturning("execution(* com.tomowork.shop.manage..*.*(..))&& @annotation(annotation)&&args(request,..) ")
	...
	@AfterThrowing(value = "execution(* com.tomowork.shop.manage..*.*(..))&&args(request,..) ", throwing = "exception")
