  ...
  jQuery("a[dialog_uri!=undefined],input[dialog_uri!=undefined],input[dialog_uri!=undefined],input[dialog_uri!=undefined]").click(function(e){
	...
	var dialog_left=300;
	 if(dialog_uri!=undefined&&dialog_uri!=""){
       ...
       jQuery(".white_content").css("position","absolute").css("top",parseInt(dialog_top)+"px").css("left",parseInt(dialog_left)+"px").css("border","10px rgba(255,255,255,0.5) solid").css("border-radius","13px");
