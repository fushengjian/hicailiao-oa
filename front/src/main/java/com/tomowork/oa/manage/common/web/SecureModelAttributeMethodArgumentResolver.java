package com.tomowork.oa.manage.common.web;
...
import com.tomowork.oa.manage.common.utils.Reflections;
...
public class SecureModelAttributeMethodArgumentResolver implements HandlerMethodArgumentResolver {
	...
	private Object createAttribute(String attributeName, MethodParameter parameter, WebDataBinderFactory binderFactory, NativeWebRequest request)
			throws Exception {
	...
	private Object createAttributeFromRequestValue(String sourceValue, String attributeName, MethodParameter parameter, WebDataBinderFactory binderFactory, NativeWebRequest request)
			throws Exception {
