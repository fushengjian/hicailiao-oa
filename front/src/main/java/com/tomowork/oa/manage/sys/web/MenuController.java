...
public class MenuController extends BaseController {
	...
	public String save(Menu menu, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:" + Global.getAdminPath() + "/sys/menu/list.do";
	}
	...
	public String tree(Long parentId, Model model) {
		model.addAttribute("currentMenu", systemService.getMenu(parentId));
