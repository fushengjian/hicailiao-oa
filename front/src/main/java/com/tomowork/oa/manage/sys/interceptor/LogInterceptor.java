...
package com.tomowork.oa.manage.sys.interceptor;
...
import com.tomowork.oa.manage.sys.dao.LogDao;
import com.tomowork.oa.manage.sys.entity.Log;
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response,
		...
		if ((StringUtils.startsWith(requestRri, uriPrefix) && (StringUtils.endsWith(requestRri, "/save")
			...
			if (manageUser != null && manageUser.getId() != null) {
				...
				logger.info("save log {type: {}, loginName: {}, uri: {}}, ", log.getType(), manageUser.getLoginName(), log.getRequestUri());
