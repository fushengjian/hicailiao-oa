...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/user/info.do">个人信息</a></li>
		<li class="active"><a href="${ctx}/sys/user/modifyPwd.do">修改密码</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="manageUser" action="${ctx}/sys/user/modifyPwd.do" method="post" class="form-horizontal">
		<form:hidden path="id"/>
