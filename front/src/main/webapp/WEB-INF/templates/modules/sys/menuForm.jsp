...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/menu/list.do">菜单列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save.do" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<tags:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">上级功能:</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="type" items="${fns:getDictList('menu_type')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
			</div>
		</div>
		<div class="control-group">
