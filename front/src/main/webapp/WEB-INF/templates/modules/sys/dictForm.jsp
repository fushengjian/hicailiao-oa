...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/dict/list.do">字典列表</a></li>
		<li class="active"><a href="${ctx}/sys/dict/form.do?id=${dict.id}">字典<shiro:hasPermission name="sys:dict:edit">${not empty dict.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:dict:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="dict" action="${ctx}/sys/dict/save.do" method="post" class="form-horizontal">
		<form:hidden path="id"/>
