...
public class HttpInclude {
	...
	private static final String sessionIdKey = "JSESSIONID";
	...
	private static boolean isRemoteHttpRequest(String includePath) {
		return (includePath != null) && (((includePath.toLowerCase()
				.startsWith("http://")) || (includePath.toLowerCase()
				.startsWith("https://"))));
	}
	...
	private void getLocalContent(String includePath, Writer writer)
		...
		String url_path = (includePath.indexOf("?") > 0) ? includePath
				.substring(0, includePath.indexOf("?")) : includePath;
	...
	public static class CustomOutputHttpServletResponseWrapper extends
		...
		public CustomOutputHttpServletResponseWrapper(
				HttpServletResponse response, Writer customWriter, final OutputStream customOutputStream) {
			super(response);
